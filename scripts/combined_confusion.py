...
DATA_DIR = "/home/paul/Msci/outputs/inference_multiclass/run1"
...
CLASS_NAMES = ["NCπ0 Corsika", "NCπ0 Only", "Cosmics Corsika", "DM Corsika", "DM Signal Only"]
...
ax.set_title("Run1 Confusion Matrix")
...
plt.savefig(os.path.join(OUTPUT_DIR, "run1_confusion_matrix.png"), dpi=300)
plt.savefig(os.path.join(OUTPUT_DIR, "run1_confusion_matrix.pdf"))
plt.show()
